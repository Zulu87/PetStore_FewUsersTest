...
class TestUsers:
    ...
    def test_user_is_added(self, current_user_client: CurrentUserClient, users_data_provider):
    ...
    def test_few_users_are_added(self, current_user_client: CurrentUserClient, users_data_provider):
